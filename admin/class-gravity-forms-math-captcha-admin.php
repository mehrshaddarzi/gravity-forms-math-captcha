...
class Gravity_Forms_Math_Captcha_Admin
{
    ...
    public function admin_warning()
    {
        ...
        if (!class_exists('RGForms') && $pagenow == 'plugins.php') {
            ...
            <div class="error">
                <p>
                    <?php _e('The Gravity Forms Math Captcha plugin requires Gravity Forms to be installed and activated. ', $this->plugin_slug); ?>
                    <a href="http://www.gravityforms.com/"
                       target="_blank"><?php _e('Please install Gravity Forms now.', $this->plugin_slug); ?></a>
                </p>
            </div>
            <?php
        }
    ...
    public function math_captcha_settings($position, $form_id)
    {
        ...
        if ($position == 25) {
            ...
            <li class="math_captcha_setting field_setting">
                ...
                <select id="field_math_captcha_type"
                        onchange="SetFieldProperty('field_math_captcha_type', jQuery(this).val());">
